...
class User {
    constructor(id, username, email) {
      ...
      static async createUser(user) {
        ...
        const sqlQuery = `INSERT INTO Users (id, username, email) VALUES (@id, @username, @email)`; // Replace with your actual table name
      ...
      static async getUserById(id) {
        ...
        const sqlQuery = `SELECT * FROM Users WHERE id = @id`; // Replace with your actual table name
        const request = connection.request();
        request.input("id", id);
        const result = await request.query(sqlQuery);
      ...
      static async updateUser(id, updatedUser) {
        ...
        const sqlQuery = `UPDATE Books SET id = @id, username = @username, email = @email WHERE id = @id`; // Replace with your actual table name
        const request = connection.request();
        request.input("id", id);
